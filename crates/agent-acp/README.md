...
captured from block/buzz `v0.5.2` (rev `3e48f1b`) — see the fixtures README
for provenance and the crate docs for the protocol-version stance (including
why the published `agent-client-protocol` crate is not used for wire types).
